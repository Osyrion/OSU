            ...
            foreach ($exams->fetch_all() as $row) {
                ...
                foreach ($exams->fetch_all() as $row) {
                    if ($row[13]) {
                        ...
                        echo "<td>" . $row[14] . "</td>";
                        echo "<td>
                        <form method=\"POST\" action=\"exams.php\" name=\"registerExam\">
                        ...
                        <input type=\"text\" class=\"visually-hidden\" name=\"capacity\" value='" . $row[13] . "'>
                        <input type=\"text\" class=\"visually-hidden\" name=\"updateExam\" value=\"updateExam\">
                        <input type=\"submit\" class=\"btn btn-success\" value=\"Registrovať\">
                        </form></td>";
                        echo "</tr>"; 
                ...
                if (!$a) {
                    echo "<tr><td class=\"text-center\" colspan=\"9\">Momentálne nie sú k dispozícii žiadne termíny.</td></tr>";
                }
